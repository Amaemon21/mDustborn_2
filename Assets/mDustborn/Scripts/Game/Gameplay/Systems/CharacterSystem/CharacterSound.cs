 ...
 public class CharacterSound : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _ikHandler = GetComponent<IKHandler>();
        }
        ...
        {
            if (!CheckAudioSource() || _ikHandler == null) return;
            _playerAudioSource.PlayOneShot(_ikHandler.PlayerSettings.generalSounds[soundIndex]);
        }
    }